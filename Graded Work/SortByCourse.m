...
@interface SortByCourse ()

@end

@implementation SortByCourse
...
- (void)viewDidLoad
{
    ...
    self.model.frc_gradedworks_sortbycourse.fetchRequest.predicate = nil;
    ...
    NSError *error = nil;
    [self.model.frc_gradedworks_sortbycourse performFetch:&error];
...
- (NSInteger)numberOfSectionsInTableView:(UITableView *)tableView
{
    ...
    //return 0;
    return [[self.model.frc_gradedworks_sortbycourse sections] count];
}
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    ...
    //return 0;
    [self viewDidLoad];
    id <NSFetchedResultsSectionInfo> sectionInfo = [[self.model.frc_gradedworks_sortbycourse sections] objectAtIndex:section];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([[self.model.frc_gradedworks_sortbycourse sections] count] == 0)
    {
    ...
    else
    {
        ...
        //NSManagedObject *d1 = [self.listSortByCourse objectAtIndex:indexPath.row];
        
        NSManagedObject *d1 = [self.model.frc_gradedworks_sortbycourse objectAtIndexPath:indexPath];
