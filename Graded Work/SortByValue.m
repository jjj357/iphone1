...
- (void)viewDidLoad
{
    ...
    NSError *error = nil;
    [self.model.frc_gradedworks_sortbyvalue performFetch:&error];
...
- (NSInteger)numberOfSectionsInTableView:(UITableView *)tableView
{
    ...
    //return 0;
    return [[self.model.frc_gradedworks_sortbyvalue sections] count];
}
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    ...
    //return 0;
    [self viewDidLoad];
    id <NSFetchedResultsSectionInfo> sectionInfo = [[self.model.frc_gradedworks_sortbyvalue sections] objectAtIndex:section];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    else
    {
        ...
        /////////
        //NSManagedObject *d1 = [self.listSortByValue objectAtIndex:indexPath.row];
        //cell.textLabel.text = song.songName;
        //cell.detailTextLabel.text = song.album.albumName;
        //////////
        
        NSManagedObject *d1 = [self.model.frc_gradedworks_sortbyvalue objectAtIndexPath:indexPath];
